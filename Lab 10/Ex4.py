...
data_file = Path(__file__).parent / "homes_data.csv"
if not data_file.exists():
    raise FileNotFoundError(f"{data_file} not found. Place homes_data.csv in the same folder as this script.")
df_homes = pd.read_csv(data_file)
